## Decided not to create instrument_repertoires table so this rake is moot
...
#       end
#     end
#     puts "Created #{count} instrument_repertoires from #{InstrumentTune.all.size} instrument_tunes"
#   end
